...
RUN docker-php-ext-install pdo zip pdo_pgsql pgsql mbstring exif intl opcache
RUN docker-php-ext-enable pdo zip pdo_pgsql pgsql gd mbstring exif intl opcache
